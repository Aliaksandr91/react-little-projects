...
export const User: FC<UserType> = ({id, avatar, email, first_name, last_name, onClickInvite, isInvited}) => {
    return (
        <li>
            <div>
            ...
            <img onClick={()=>onClickInvite(id)} className="action" src={`assets/${isInvited ? 'minus' : 'plus'}.svg`}
                 alt="Action"/>
        </li>
    );
};
